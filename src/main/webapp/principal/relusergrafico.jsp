														...
														<div class="form-row align-items-center">
															...
															<div class="col-auto">
																<label class="sr-only" for="dataInicial">Data
																	...
																	value="${dataInicial}" placeholder="Data Inicial">
															</div>
															...
															<div class="col-auto">
																...
																<div class="input-group mb-2">
																	<input type="text" class="form-control" id="dataFinal"
																		name="dataFinal" value="${dataFinal}" placeholder="Data Final">
																</div>
															</div>

															<div class="col-auto">
																<button type="button" onclick="gerarGrafico()"
																	class="btn btn-primary mb-2">Gerar Gráfico
																	</button>
				 ...
				 myChart = new Chart(
						document.getElementById('myChart'),
						{
						    ...
						    data: {
							    labels: json.perfils,
							    datasets: [{
							      label: 'Fráfico de Média Salarial por Tipo',
